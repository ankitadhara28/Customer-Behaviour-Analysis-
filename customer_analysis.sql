...
-- Q4. Compare the average Purchase amounts between standard and express delivery.
...
round(100 * sum(case when discount_applied = 'Yes' then 1 else 0 end)/count(*)::numeric, 2) as discount_rate
from customer
group by item_purchased
